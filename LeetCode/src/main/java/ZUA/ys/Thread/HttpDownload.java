...
/**
 * Description
 * https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/Anaconda-1.4.0-Windows-x86_64.exe
 * @author YS
...
public class HttpDownload {
    ...
    public static void main(String[] args) throws IOException {
        String url = "http://dl.maxthon.cn/cn/mx2/mx_2.5.1.4751cn.exe";
//        String url = "http://mirrors.163.com/debian/ls-lR.gz";
        new HttpDownload(url, "C:\\Users\\41765\\Desktop\\temp\\", 1, 5000).get();
    }
